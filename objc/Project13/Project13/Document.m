...
//    return YES;
    ...
    if (loadedScreenshot != nil) {
        self.screenshot = loadedScreenshot;
        return YES;
    } else {
        NSError *badDataError = [[NSError alloc] initWithDomain:@"com.pookjw.Project13" code:2 userInfo:@{
            NSLocalizedDescriptionKey: @"Bad Data!"
        }];
        *outError = badDataError;
        return NO;
    }
}
